  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-2">AVERADAO - Terms of Service</h1>
        <p className="text-sm text-gray-500 mb-8">Last Updated: November 2025</p>
        <div className="space-y-6 text-gray-800">
          <p>Welcome to AVERADAO ("we," "our," or "AVERADAO"). By accessing or using ___AVERADAO_DOMAIN___, our applications, smart contracts, portals, or any associated services (collectively, the "Services"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use our Services.</p>
          <h2 className="text-xl font-bold text-gray-900">1. Nature of the Platform</h2>
          <p>AVERADAO is a decentralized asset recovery protocol designed to:</p>
          ...
          <p>AVERADAO is not an insurance company, financial institution, broker, or legal service provider. All functions are executed through blockchain-based smart contracts.</p>
          ...
          <p>Submitting a claim does not guarantee verification, token issuance, fund distribution, or any level of financial compensation. All distribution decisions are made through structured, verifiable processes. AVERADAO assumes no responsibility for outcomes.</p>
          ...
          <p>By using AVERADAO, you acknowledge and accept smart contract bugs, possible loss of tokens, network failures, and that transactions are irreversible. AVERADAO provides no warranties, explicit or implied.</p>
          ...
          <p>AVERADAO may link to third-party platforms, wallet providers, and exchange platforms. We do not control or endorse third-party services and are not responsible for their actions or policies.</p>
          <h2 className="text-xl font-bold text-gray-900">9. Intellectual Property</h2>
          <p>Unless otherwise stated, all website text, design, and branding belong to AVERADAO. You may not copy, modify, or distribute our content without permission.</p>
          ...
          <p>To the maximum extent permitted by law, AVERADAO, its contributors, members, and partners are not liable for loss of funds or tokens, service interruptions, errors in claim verification, or any indirect, incidental, or consequential damages. Your use of the platform is at your own risk.</p>
